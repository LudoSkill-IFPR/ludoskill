...
<body>
    ...
    <main><div class="container">
        <div id="topo"><a class="botao brilho" href="<?= URL_BASE ?>/administrador/empresas">Voltar</a><div><h1>Cadastro de Empresa</h1><p class="mensagem">Cadastre uma nova empresa no LudoSkill.</p></div></div>
